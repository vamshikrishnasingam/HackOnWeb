...
function Community({ mainCommunityDetails, sendDataToParent }) {
    ...
    const handleClickButton = async (event) => {
        try {
            const response = await axios.get('https://localhost:5014/api/Hackathons/GetAllUsers');
                    ...
                    <div className="">
                        ...
                        <div className="grid grid-cols-1">
                            <div className="col-span-full">
                                ...
                                <div className='mb-3'>
                                    <h4 className="heading text-dark text-left mt-3" id="">UPLOAD FILES & LINKS</h4>
                                            ...
                                            <div className="linkbox flex  bg-white pl-2">
                                                ...
                                                <div className="">
                                                    <button className="flex buttonlink" onClick={handleGithubLinkSubmit}>
                                                        <svg xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className=" h-7">
                                            ...
                                            <div className="linkbox flex  bg-white pl-2">
                                                ...
                                                <div>
                                                    <button className="flex buttonlink" onClick={handleAppLinkSubmit}>
                                                        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-7">
